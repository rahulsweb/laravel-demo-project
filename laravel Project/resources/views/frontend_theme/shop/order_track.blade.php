...
<div class="row shop-tracking-status">
    ...
    <form action="{{ route('order.track') }}" method="POST" id="order_form">
{{ csrf_field() }} 
            ...
            <div class="form-horizontal">
                <div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}">
                    <label for="inputOrderTrackingID" class="col-sm-2 control-label text-info">Order Email</label>
                        ...
                        <input type="text" data-parsley-trigger="keyup" data-parsley-type="email" type="text" id="email"  class="form-control" name="email" id="email" value="" placeholder="# put your order email id here">
